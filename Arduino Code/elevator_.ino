...
/* Includes ---------------------------------------------------------------- */
#include <Overload_Alert_in_Elevators_inferencing.h>
...
#define threshold                                 3   // You can set the no of passengers here
...
void setup()
{
    ...
    Serial.println("Date&Time,Count");
    ...
    pinMode(A0, INPUT);         // push button pin set to input
    pinMode(PF_3, OUTPUT);         // Led and buzzer set to output
}
...
void loop()
{
    ...
    unsigned int value  = analogRead(A0); // Reading push button status
    //Serial.println("Reading Value : ");
    //Serial.print(value);
    if(value < 100) 
    {     
          // Door closed , Lift starts off
          //ei_printf("\nCounting Initiated\n");
          ...
          //Serial.println("Passengers Count : ");
          Serial.print(",");
